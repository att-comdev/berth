#!/usr/bin/python
#
# I don't like this code.  It's really pretty gross and likely harms
# mammals.  Another version of this used jsonschema.validate but error
# output there was hard to deal with so we're doing this by hand for
# now.
#
# Whilst this is quite tedious we have limited scope and if nothing
# else it allows us to give more detailed/appropriate errors.
